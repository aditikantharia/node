...
//cors-->allow only that website or port that mentioned in origin to access the backend server.
// backend only response when localhost 3002 send request other than give cors origin error.
